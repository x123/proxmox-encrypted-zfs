...
# --- 2. CREATE THE ZFS EXTENSION SCRIPT ---
# ZFS boot script explicitly sources this file if it exists.
...
# NETWORK WAIT LOOP (Max 30s)
# We need to wait because this extension runs very early in the boot process
MAX_RETRIES=30
i=0
...
# Make it executable (though sourcing doesn't strictly require it, it's good practice)
